...
docker exec -it bibbox-web bin/console db:install
...
docker exec -it bibbox-web sed -i 's/session.cookie_secure = true/session.cookie_secure = false' ../etc/php81/php.ini
